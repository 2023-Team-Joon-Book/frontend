  ...
  return (
    <div className="flex items-center justify-center py-4 px-8">
      <div className="flex w-80 rounded-full overflow-hidden">
        <button
          className={`${activeTab === 'stack' ? 'bg-bfc66a text-white rounded-full' : 'bg-white text-bfc66a rounded-full'
        ...
        <button
          className={`${activeTab === 'trend' ? 'bg-bfc66a text-white rounded-full' : 'bg-white text-bfc66a rounded-full'
